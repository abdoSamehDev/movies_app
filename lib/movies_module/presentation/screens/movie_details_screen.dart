...
// import 'package:movies_app/core/utils/dummy%20.dart';
...
//     return BlocProvider(
//       create: (context) => sl<MovieDetailsBloc>()..add(GetMovieRecommendationEvent(id))..add(GetMovieDetailsEvent(id)),
//       lazy: false,
...
//                     imageUrl: AppConstants.imageUrl(state.movieDetails!.backdropPath),
//                     fit: BoxFit.cover,
//                   ),
//                 ),
//               ),
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                return FadeInUp(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: AppConstants.imageUrl(recommendation.backdropPath!),
                      placeholder: (context, url) => Shimmer.fromColors(
                        baseColor: Colors.grey[850]!,
                        highlightColor: Colors.grey[800]!,
                        child: Container(
